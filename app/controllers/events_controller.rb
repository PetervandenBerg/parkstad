class EventsController < ApplicationController
  ...
  def show
    ...
    @attendances = @event.attendances(@event)
    @attending = @event.attendances.where(attending: true).count
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:name, :all_day, :start_at, :end_at, :user_id, :kind)
    end
end
